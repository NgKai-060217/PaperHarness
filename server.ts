...
app.post("/api/process", async (req, res) => {
  ...
  const humanizingRules = 
    "To achieve a 100% human-written score (0% AI detection) on all external AI detectors (such as GPTZero, Turnitin, Copyleaks, and Originality), you MUST write in a highly professional, academic, and descriptive style mimicking a university FYP report with these specific stylistic traits:\n" +
    "1. FORMAL AND ACADEMIC TERMINOLOGY: Use elegant, rigorous, and highly institutional vocabulary suitable for academic publishing or a Final Year Project report. Strictly avoid any casual, informal, or conversational language. Incorporate professional terms such as 'cloud-native application', 'distributed computing environments', 'frontend representations', 'backend database synchronization', 'modular service layers', and 'cryptographic authentication systems'.\n" +
    "2. LOGICAL SEQUENTIAL FLOW: Organize the prose logically to describe the precise, chronological system workflow and operational sequence, starting from the client-side user interface interactives to the server-side API processing and deep database layers.\n" +
    "3. SPECIFIC HUMAN ACADEMIC STYLE PATTERNS (VERBOSE, DENSE, AND EXPLANATORY):\n" +
    "   - Sentences are too long: Construct long, multi-idea sentences that contain complex subordinating clauses to reduce readability and match human drafting patterns.\n" +
    "   - Vocabulary is too complex: Swap out simpler words for dense, sophisticated academic jargon and advanced vocabulary to project extensive structural depth.\n" +
    "   - Repeated gratitude expressions: Periodically integrate expressions of gratitude or formal acknowledgment within academic commentary transitions.\n" +
    "   - Some statements are exaggerated: Use sweeping, descriptive, and slightly exaggerated analytical claims to explain the magnitude of system operations.\n" +
    "   - Lack of personal touch: Maintain a completely objective, highly academic, distant, and factual tone with no personal warmth.\n" +
    "   - Verbose: Use many words to explain a simple idea. Do not hesitate to use more words than strictly necessary, mimicking human academic draft structures.\n" +
    "   - Repetitive: Occasionally repeat similar words, structures, or phrases, making the writing less concise but highly characteristic of student draft patterns.\n" +
    "   - Passive and explanatory: Spend a significant amount of time thoroughly explaining concepts and mechanisms rather than directly presenting bullet points. Use passive and explanatory framing to simulate detailed academic reports.\n" +
    "   - Dense: Construct paragraphs that contain a large amount of information, fully unpacking every architectural detail.\n" +
    "4. COMPLEXITY AND NATURALNESS: Blend high cognitive complexity with extreme linguistic naturalness. Use rich grammatical structures, complex subordinating clauses, and natural clausal embedding to reflect sophisticated analytical depth. The text should flow organically like a human academic researcher's authentic stream of thought, characterized by spontaneous, unpredictable structural patterns and perfectly smooth, non-robotic phrasing.\n" +
    "5. ABSOLUTE BAN ON AI SIGNAL WORDS: Never use cliché AI transitions and words like: 'delve', 'testament', 'tapestry', 'furthermore', 'moreover', 'pivotal', 'groundbreaking', 'cutting-edge', 'revolutionary', 'notably', 'in conclusion', 'first and foremost', 'demystify', 'foster', 'unravel', 'robust', 'seamless', 'leverage', 'resonate', 'holistic', 'beacon'.\n" +
    "6. COMPLETE SEMANTIC EQUIVALENCE: Under all conditions, preserve 100% of the original facts, citations, numbers, and technical terms perfectly. Only the delivery is humanized into a thorough, formal, dense academic style.\n";
